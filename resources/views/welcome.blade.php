...
<body>
    ...
    <header id="header">
        <div class="container-fluid">
            ...
            <div id="logo" class="pull-left">
                <h1><a href="#intro" class="scrollto">AMAM Station</a></h1>
            ...
            <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active">
                        <div class="carousel-background"><img src="{{ asset('assets/img/intro-carousel/1.jpg') }}"
                                alt=""></div>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-background"><img src="{{ asset('assets/img/intro-carousel/2.jpg') }}"
                                alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                    ...
                    <div class="carousel-item">
                        <div class="carousel-background"><img src="{{ asset('assets/img/intro-carousel/3.jpg') }}"
                                alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                    ...
                    <div class="carousel-item">
                        <div class="carousel-background"><img src="{{ asset('assets/img/intro-carousel/4.jpg') }}"
                                alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                    ...
                    <div class="carousel-item">
                        <div class="carousel-background"><img src="{{ asset('assets/img/intro-carousel/5.jpg') }}"
                                alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
            ...
            <div class="container">
                ...
                <div class="row portfolio-container">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
                        <div class="portfolio-wrap">
                            <figure>
                                ...
                                <a href="{{ asset('assets/img/portfolio/app1.jpg') }}" data-lightbox="portfolio"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
                        <div class="portfolio-wrap">
                            <figure>
                                ...
                                <a href="{{ asset('assets/img/portfolio/web3.jpg') }}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
                        <div class="portfolio-wrap">
                            <figure>
                                ...
                                <a href="{{ asset('assets/img/portfolio/app2.jpg') }}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="{{ asset('assets/img/portfolio/card2.jpg') }}" class="img-fluid"
                                    alt="">
                                <a href="{{ asset('assets/img/portfolio/card2.jpg') }}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
                        <div class="portfolio-wrap">
                            <figure>
                                ...
                                <a href="{{ asset('assets/img/portfolio/web2.jpg') }}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
                        <div class="portfolio-wrap">
                            <figure>
                                ...
                                <a href="{{ asset('assets/img/portfolio/app3.jpg') }}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="{{ asset('assets/img/portfolio/card1.jpg') }}" class="img-fluid"
                                    alt="">
                                <a href="{{ asset('assets/img/portfolio/card1.jpg') }}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp" data-wow-delay="0.1s">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="{{ asset('assets/img/portfolio/card3.jpg') }}" class="img-fluid"
                                    alt="">
                                <a href="{{ asset('assets/img/portfolio/card3.jpg') }}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.2s">
                        <div class="portfolio-wrap">
                            <figure>
                                ...
                                <a href="{{ asset('assets/img/portfolio/web1.jpg') }}" class="link-preview"
  ...
  ============================-->
    <footer id="footer">
        ...
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong>AMAM Station</strong>. All Rights Reserved
            </div>
            <div class="credits">
                <!--
        ...
        -->
                Designed by <a href="https://muhamedali.ml/">Mohamed ALi</a>
            </div>
        </div>
    </footer><!-- #footer -->
